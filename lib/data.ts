...
export type Message = { id: string; from: string; to: string; text: string; at: string; };
...
export const SPACES: Space[] = [
  { id:'528', name:'528 Film',          color:'#7C3AED', emoji:'film' },
  { id:'rz',  name:'RenderZero',        color:'#0EA5E9', emoji:'bolt' },
  { id:'lab', name:'AI Experience Lab', color:'#10B981', emoji:'lab' },
];
export const LISTS: TaskList[] = [
  ...
  { id:'l5', space:'lab', name:'Concept and Design',  color:'#10B981' },
];
...
export const INITIAL_TASKS: Task[] = [
  { id:'t1', title:'Colour grade scene 1-4',    list:'l1', status:'in_progress',      priority:'urgent', assignees:['vm'],      due:'2026-03-20', est:180, logged:120, description:'Grade scenes 1-4 using approved LUT.', subtasks:[{id:'s1',title:'Apply LUT',done:true},{id:'s2',title:'Match skin tones',done:false}], comments:[{id:'c1',user:'hk',text:'Priority - client review Thursday.',at:'2026-03-16T09:00'}], tags:['film','review'], createdAt:'2026-03-10T08:00' },
  ...
  { id:'t3', title:'Narration VO record',        list:'l1', status:'pending_approval', priority:'urgent', assignees:['hk','vm'], due:'2026-03-18', est:120, logged:60,  description:'Record and edit final narration VO.', subtasks:[], comments:[{id:'c2',user:'pr',text:'Studio booked for 2pm tomorrow.',at:'2026-03-16T10:30'}], tags:['urgent'], createdAt:'2026-03-12T09:00' },
  { id:'t4', title:'Storyboard review',          list:'l1', status:'done',             priority:'normal', assignees:['vm','pr'], due:'2026-03-15', est:90,  logged:85,  description:'Review storyboard panels 1-40.', subtasks:[{id:'s7',title:'Panels 1-20',done:true},{id:'s8',title:'Panels 21-40',done:true}], comments:[], tags:[], createdAt:'2026-03-08T09:00' },
  { id:'t5', title:'GPU cluster setup',          list:'l3', status:'in_progress',      priority:'high',   assignees:['hk'],      due:'2026-03-22', est:300, logged:90,  description:'Configure 8x A100 GPU cluster for RenderZero.', subtasks:[{id:'s9',title:'Driver install',done:true},{id:'s10',title:'CUDA config',done:false}], comments:[], tags:['infra'], createdAt:'2026-03-13T09:00' },
  ...
  { id:'t7', title:'AI concept wireframes',      list:'l5', status:'in_progress',      priority:'normal', assignees:['pr'],      due:'2026-03-21', est:120, logged:60,  description:'Wireframe the AI chat interface.', subtasks:[], comments:[], tags:['ai'], createdAt:'2026-03-14T10:00' },
  { id:'t8', title:'Post credits sequence edit', list:'l2', status:'todo',             priority:'low',    assignees:['vm'],      due:'2026-03-28', est:60,  logged:0,   description:'Edit the post-credits sequence.', subtasks:[], comments:[], tags:['film'], createdAt:'2026-03-15T09:00' },
];
export const INITIAL_MESSAGES: Message[] = [
  { id:'m1', from:'vm', to:'hk', text:'Hey, colour grade is looking great. Small note on highlights in scene 3.', at:'2026-03-16T08:30' },
  { id:'m2', from:'hk', to:'vm', text:'Thanks! Will pull those down. Ready for review by 3pm.', at:'2026-03-16T08:45' },
...
export const DOCS = [
  { id:'d1', title:'Project Brief 528 Film',            type:'Brief',        icon:'doc',  size:'2.4 MB', updated:'Mar 14', tags:['film','urgent'] },
  { id:'d2', title:'Sprint 3 Planning Notes',           type:'Meeting Notes',icon:'note', size:'840 KB', updated:'Mar 15', tags:['review'] },
  { id:'d3', title:'Sound Design Spec',                 type:'Spec',         icon:'audio',size:'1.1 MB', updated:'Mar 12', tags:['film'] },
  { id:'d4', title:'RenderZero Technical Architecture', type:'Architecture', icon:'arch', size:'3.2 MB', updated:'Mar 10', tags:['infra'] },
  { id:'d5', title:'AI Assistant Prompt Library',       type:'Reference',    icon:'ai',   size:'560 KB', updated:'Mar 13', tags:['ai'] },
  { id:'d6', title:'Client Presentation Deck',          type:'Presentation', icon:'deck', size:'18 MB',  updated:'Mar 15', tags:['film','review'] },
];
