...
export type Conversation = {
  id: string; name: string; type: 'dm' | 'group'; members: string[]; createdAt: string;
};
...
export const INITIAL_TASKS: Task[] = [
  ...
  { id:'t6', title:'REST API — render endpoints',  list:'l4', spaceId:'rz', status:'todo',             priority:'normal', assignees:['hk'],         due:'2026-03-25', est:240, logged:0,   description:'Build /render, /status, /cancel endpoints.', subtasks:[], comments:[], tags:[], createdAt:'2026-03-14T09:00' },
...
export const INITIAL_CONVERSATIONS: Conversation[] = [
  { id: 'dm_hk_vm', name: '', type: 'dm', members: ['hk','vm'], createdAt: '2026-03-01T00:00' },
  { id: 'dm_ds_hk', name: '', type: 'dm', members: ['ds','hk'], createdAt: '2026-03-01T00:00' },
  { id: 'dm_hk_pr', name: '', type: 'dm', members: ['hk','pr'], createdAt: '2026-03-01T00:00' },
  { id: 'dm_ds_vm', name: '', type: 'dm', members: ['ds','vm'], createdAt: '2026-03-01T00:00' },
  { id: 'dm_pr_vm', name: '', type: 'dm', members: ['pr','vm'], createdAt: '2026-03-01T00:00' },
  { id: 'dm_ds_pr', name: '', type: 'dm', members: ['ds','pr'], createdAt: '2026-03-01T00:00' },
];
